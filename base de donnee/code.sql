...
/*permet d'alimenter la table tarif avec 3 tarifs différents*/

insert into tarif (nom, prix) VALUES ('plein tarif', '9.20'),
                                     ('étudiant', '7.60'),
                                     ('moins de 14 ans', '5.90');

/*permet d'ajouter 5 salle */
...
/*permet d'afficher les détails de chaque seance*/
